...
SECRET_KEY = 'django-insecure-fkxn&j@huv-z%7da7hyiu=p&%d)j5y1wr%f0(*1--kny8m)5iz'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "bank_management.context_processors.count_notifications",
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'banking_system_db.sqlite3',
    }
}
...
EMAIL_HOST_PASSWORD = "npzrcytslnevugcb"
EMAIL_USE_TLS = True
EMAIL_PORT = 587