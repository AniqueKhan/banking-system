# Generated by Django 3.2.18 on 2023-03-27 14:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dependents', models.IntegerField(choices=[(0, '0'), (1, '1'), (2, '2'), (3, '3'), (4, '4')])),
                ('education', models.CharField(choices=[('graduated', 'Graduated'), ('not_graduated', 'Not Graduated')], max_length=13)),
                ('applicant_income', models.FloatField()),
                ('co_applicant_income', models.FloatField(blank=True, null=True)),
                ('property_area', models.CharField(blank=True, choices=[('rural', 'Rural'), ('urban', 'Urban')], max_length=5, null=True)),
